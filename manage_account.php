...
<body>
    <div id="page_contents">
        ...
        <h2 style="word-wrap: break-word;" class="primary_page_title">Welcome <?php echo string_sanitize($user_info_retrieval[0]["user_name"]); ?></h2>
        ...
        <div class="center_container"><a href="./manage_uploads.php">Manage uploads</a></div>
