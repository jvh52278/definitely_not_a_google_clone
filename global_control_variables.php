<?php
    ...
    $force_upload_limiter = true; // if true, if a non-admin user has more than 7 uploads, each additional upload will have a minimum 50% chance of failure
    $upload_limit_before_kickback = 7;
